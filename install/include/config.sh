...
mysql_data_back_dir=/home/data/mysqlback
...
#mariadb10.4
mariadb10_4_filename="mariadb-10.4.27"
#mariadb10.5
mariadb10_5_filename="mariadb-10.5.18"
#mariadb10.6
mariadb10_6_filename="mariadb-10.6.11"
#mariadb10.7
...
#php8.1
php8_1_filename="php-8.1.12"
php8_1_filename_url="https://www.php.net/distributions/php-8.1.12.tar.gz"
#phpMyAdmin
...
phpmyadmin_filename_url="${download_root_url}/phpMyAdmin-5.2.0-all-languages.tar.gz"
#Adminer
...
cmake_filename_url2="${download_root_url}/cmake-3.18.0-Linux-x86_64.tar.gz"
#libzip
...
#snmp
snmp_filename="net-snmp-5.7.3"
snmp_filename_url="${download_root_url}/net-snmp-5.7.3.tar.gz"
