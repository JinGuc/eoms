...
class Sql():
    ...
    __OPT_FIELD = "*"  # field条件
    __OPT_PARAM = ()  # where值
    __LOCK = '/opt/snmp/py-eoms/data/sqlite_lock.pl'

    def __init__(self):
        self.__DB_FILE = '/opt/snmp/py-eoms/data/default.db'
    ...
    def dbfile(self, name):
        self.__DB_FILE = '/opt/snmp/py-eoms/data/' + name + '.db'
        return self
    ...
    def create(self, name):
        ...
        self.write_lock()
        self.__GetConn()
        script = public.readFile('/opt/snmp/py-eoms/data/' + name + '.sql')
