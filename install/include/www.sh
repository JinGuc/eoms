...
install_www(){
    ...
    sed "s/DB_HOST=/DB_HOST=${dbhost}/g" ${web_root_dir}/.env
    sed "s/DB_USERNAME=/DB_USERNAME=${dbname}/g" ${web_root_dir}/.env
    sed "s/DB_PASSWORD=/DB_PASSWORD=${password}/g" ${web_root_dir}/.env
